namespace Humper
{
	...
	public interface IBox
	{
        ...
        /// <summary>
		/// Tries to move the box to specified coordinates without collision detection.
		/// </summary>
		/// <param name="x">The x coordinate.</param>
		/// <param name="y">The y coordinate.</param>
        ...
        /// <summary>
        /// Tries to move the box to a simulated movement.
        /// </summary>
        /// <param name="movement">The output from <see cref="Simulate(float, float, Func{ICollision, ICollisionResponse})">Simulate</see>.</param>
        void Teleport(IMovement movement);
