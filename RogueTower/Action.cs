        ...
        public override void GetPose(PlayerState basePose)
        {
            ...
            switch (SlashAction)
            {
                ...
                case (SwingAction.StartSwing):
                    ...
                    basePose.Weapon = Weapon.GetWeaponState(MathHelper.ToRadians(-135.5f));
                    break;
                case (SwingAction.UpSwing):
                ...
                case (SwingAction.DownSwing):
                    ...
                    basePose.Weapon = Weapon.GetWeaponState(MathHelper.ToRadians(22.5f));
                    break;
                case (SwingAction.FinishSwing):
                    basePose.LeftArm = ArmState.Angular(ArmAngle);
                    basePose.Weapon = Weapon.GetWeaponState(MathHelper.ToRadians(Angle));
                    break;
            }
        }
